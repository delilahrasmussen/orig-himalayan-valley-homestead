...
import { StayOptionCard } from '../components/ui/Card';
    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 section-container">
        <div className="max-w-2xl">
          ...
          <Button href="/experiences" variant="white">
            Things to Do Nearby
  ...
  return (
    <Section bg="sage" padding="lg">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <blockquote className="text-2xl md:text-3xl font-serif text-stone-700 mb-8 leading-relaxed">
          "A perfect escape to nature in this spacious home surrounded by greenery.
          The rooftop terrace with mountain vistas was absolutely breathtaking."
        </blockquote>
        <div className="text-stone-600">
          <p className="font-medium">Guest Review</p>
          <p className="text-sm">via Airbnb</p>
        </div>
        <div className="mt-8">
          <a
